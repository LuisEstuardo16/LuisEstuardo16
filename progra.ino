...
const char *ssid = "CLARO_6A6495";
const char *password = "553Y5htaxH";
        ...
        { // if the byte is a newline character
          ...
          if (currentLine.length() == 0)
          {
            ...
            client.println(".button2 {background-color: #FF4D8E;}</style></head>");
             ...
             client.println("<style>html { font-family: Helvetica; display: inline-block; margin: 0px auto; text-align: center;}");
            client.println(".button { background-color: #FF5733; border: none; color: red; padding: 16px 40px;");
            client.println("text-decoration: none; font-size: 30px; margin: 2px; cursor: pointer;}");
            client.println(".button2 {background-color: #DBFF33;}</style></head>");
